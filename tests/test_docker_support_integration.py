...
def test_hosts_without_domain_can_resolve_each_other(testdir):
    smart_create(testdir.tmpdir, '''
    ## inventory
    guesthost1 goodplay_image=busybox:latest
    guesthost2 goodplay_image=busybox:latest
...
def test_hosts_with_domain_can_resolve_each_other(testdir):
    smart_create(testdir.tmpdir, '''
    ## inventory
    host1.domain1.tld goodplay_image=busybox:latest
    host2.domain1.tld goodplay_image=busybox:latest
    host1.domain2.tld goodplay_image=busybox:latest
...
def test_hosts_can_resolve_google_com_domain(testdir):
    smart_create(testdir.tmpdir, '''
    ## inventory
    guesthost goodplay_image=busybox:latest
